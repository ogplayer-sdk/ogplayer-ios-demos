...
struct DrmDemo: View {
    ...
    /// are hidden; the multi-DRM stream (three audio languages, three subtitle
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("FairPlay Streaming — EZDRM public test asset. The SDK fetches "
                             ...
                             + "the multi-DRM stream has three of each and shows them.")
    ...
    private func reload() {
        ...
        case .multiDrm:
            // The same encrypted stream, FairPlay flavor.
            drm = FairPlayConfig(
                certificateURLString: sharedCertificateURL,
                licenseServerURLString: sharedLicenseURL,
                licenseHeaders: ["X-AxDRM-Message": sharedToken],
                requestFormat: .binary)
        }
...
// Public multi-DRM test vector, FairPlay flavor. Public test credentials.
